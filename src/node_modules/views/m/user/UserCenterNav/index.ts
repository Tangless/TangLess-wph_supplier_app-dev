...
import setUp = require('views/m/user/SetUp');
...
class VPresenter extends project.VPresenter {
    ...
    /**设置 */
    private _evt_setUp() {
        this.setBody(this, "SetUp");
        tomato.getTopDialog().close();
        tomato.getVPresenter<setUp>(funs.moduleToUrl('m/user/SetUp'), (setUp) => {
            funs.loadPage(setUp);
        })
    }
    // /**注销登录 */
    ...
    public setBody(body, type) {
        ...
        if (type == "UserInfo") {
            ...
            this.find(".setUp").addClass("curTab");
        }
    }
}
export = VPresenter;