    ...
    private _evt_saveUserInfo() {
        ...
        if(that.find(".btn").text()=="保存"){
            ...
            api.SetUserInfo(userInfo, function (data: any) {
                that.find(".user-hide").removeClass("hide");
                that.find(".btn").text("编辑");
                funs.tip("保存成功", "", "succ");
                //成功,刷新页面
                that.setGlobalData();
            ...
            that.find(".user-hide").addClass("hide");
            that.find(".btn").text("保存");
            that.find(".input-name").focus();;
        }
    }
    _afterInstallTo() {
        this.getGlobalData();
        this.find(".user-hide").removeClass("hide");
        this.find(".btn").text("编辑");
    }
    setGlobalData() {
