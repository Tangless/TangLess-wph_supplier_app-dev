...
<script type='text/javascript'>
    // android
    window.deviceData = '';
    //   window.android_info.getPhoneInfo();
    function getAndroidMsg(message) {
        //dosomething message就是Android传递过来的数据
        var data = JSON.stringify(message);
        // alert("FromAndroidMessage:"+message);
        // alert("JSON.stringify(FromAndroidMessage):"+JSON.stringify(message));
        // alert(typeof(message));
        window.deviceData = message;
        localStorage.setItem("deviceData", JSON.stringify(message));
        $(document).trigger('deviceDataChanged');
    }
    //ios
    function getIosMsg(message) {
        //dosomething message就是IOS传递过来的数据
        var data = JSON.stringify(message);
        // alert("FromIosMessage:"+message);
    ...
    /**显示通讯录 */
    function getAndroidPhoneContact(message) {
        // message就是Android传递过来的数据
        window.PhoneContact = message;
        // alert("PhoneContact:::" + message)
        // alert("JSON.stringify(PhoneContact):" + JSON.stringify(message));
    }

    function getIosPhoneContact(message) {
        // message就是IOS传递过来的数据
        window.PhoneContact = message;
        // alert("PhoneContact:::" + message)
        // alert("JSON.stringify(PhoneContact):" + JSON.stringify(message));
    ...
    /**app状态码 */
    //android
    window.android_info.getAppStatusInfo();
    function androidAppStatusChanged(message) {
        //dosomething message就是Android传递过来的数据
    }
    //ios
    function iosAppStatusChanged(message) {
        //dosomething message就是IOS传递过来的数据
