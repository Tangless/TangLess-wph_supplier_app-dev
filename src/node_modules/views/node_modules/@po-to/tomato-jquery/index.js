...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(1), __webpack_require__(2), __webpack_require__(6), __webpack_require__(7)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, tomato, css, tpl_CommonDialog, tpl_TurnContainer) {
	    ...
	    var CommonPageApplication = (function (_super) {
	        ...
	        function CommonPageApplication(rootUri) {
	            return _super.call(this, rootUri, { view: $(document.body), dialog: $(document.body.children[0]), mask: $('') }) || this;
	        }
	    ...
	    var SinglePageApplication = (function (_super) {
	        ...
	        function SinglePageApplication(rootUri, config, els) {
	            var _this = this;
	            if (!els) {
	            ...
	            _this = _super.call(this, rootUri, els, config) || this;
	        ...
	        SinglePageApplication.prototype.refreshLayout = function () {
	            ...
	            this.header && this.header.height(headerHeight);
	            this.footer && this.footer.height(footerHeight);
	            this.aside && this.aside.width(asideWidth);
	    ...
	    var VPresenter = (function (_super) {
	        ...
	        VPresenter.prototype.setInstallEffect = function (isBack) {
	            this.view.attr('data-back', isBack ? "true" : '');
	            if (this.isWholeVPresenter()) {
	                var mod = this;
	                var jdom = mod.getHeader();
	    ...
	    var CommonDialog = (function (_super) {
	        ...
	        CommonDialog.prototype.refreshSize = function () {
	            ...
	            var sizeContent = { width: false, height: false };
	            ...
	            if ((sizeContent.width || sizeContent.height) && this.content && this.content.isWholeVPresenter()) {
	                var headerHeight = 0, footerHeight = 0, asideWidth = 0;
	                if (this._contentHeader) {
	                    headerHeight = Math.ceil(this._contentHeader.outerHeight(true));
	                }
	                ...
	                dialogSize.width += asideWidth;
	                dialogSize.height += headerHeight + footerHeight;
	            }
