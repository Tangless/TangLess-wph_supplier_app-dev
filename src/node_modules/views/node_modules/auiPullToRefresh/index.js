	...
	auiPullToRefresh.prototype = {
        ...
        _init : function(callback) {
			...
			self.params.container.addEventListener('touchstart', function(ev){
				/*为发现页定制化的处理*/
				if($("#ProjectList-container").scrollTop()>0){
					return;
				}
				/*为发现页定制化的处理*/
				self.touchStart(ev)
...
/*===========================
auiPullToRefresh AMD Export
===========================*/
if (typeof(module) !== 'undefined')
{
    module.exports = window.auiPullToRefresh;
}
else if (typeof define === 'function' && define.amd) {
    define([], function () {
        'use strict';
        return window.auiPullToRefresh;
    });
}
//# sourceMappingURL=maps/auiPullToRefresh.js.map